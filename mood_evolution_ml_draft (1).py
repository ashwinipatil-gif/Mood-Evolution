...
"""## Step 3 — import the ML classes from the file just assembled"""
...
streamlit_process = subprocess.Popen(
    [sys.executable, "-m", "streamlit", "run", "mood_evolution.py",
...
# Paste your ngrok token when this prompts you — it won't be displayed on
# screen, and it never gets typed into the code itself, so it can't end up
# stuck in the notebook if you share or submit it later.
NGROK_AUTH_TOKEN = getpass("Paste your ngrok auth token and press Enter: ")
